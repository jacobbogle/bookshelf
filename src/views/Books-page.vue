...
export default {
  setup() {
    const { state, getBooks, deleteBook, getBookshelf, getSession, postPosts, compareName, patchBookShelfPublic, deletePost } = BookShelf();
    return { state, getBooks, deleteBook, getBookshelf, getSession,postPosts, compareName, patchBookShelfPublic, deletePost };
  },
  data() {
    return {
      viewComments: false,
